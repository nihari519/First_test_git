...
public class TC3_VerifyProductsMenu extends ApplicationUtil {
	...
	@Test
	public void testTC3_VerifyProductsMenu() throws Throwable {
		for (int iLoop = 2; iLoop <= inputSheet.getPhysicalNumberOfRows(); iLoop++) {
			try {
				...
				if (runStatus.trim().equalsIgnoreCase("Y") && Testcase.trim().equalsIgnoreCase("TC3_VerifyProductsMenu")) {
